    ...
    public String modificarPaciente(@RequestParam String nombre,
        ...
        try {
            ...
            if (usuarioPacienteOptional.isPresent()) {
                ...
                usuarioPacienteServicio.modificarPaciente(nombre, apellido, email, passwordActual, nuevoPassword, obraSocial,
                        dni, direccion, telefono, Boolean.TRUE);
                ...
                return "redirect:/paciente/dashboard-paciente"; // Puedes redirigir a la vista de modificar profesional o hacer lo que
